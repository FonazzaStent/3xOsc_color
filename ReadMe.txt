...
A color calculator for the 3xOsc synth built in all versions of FL Studio from Image-Line.
The program will take channel values for an RGB color as an input and output volume parameters for each
oscillator on the 3xOsc synth found on all versions of FL Studio from Image-Line. Volume values for
